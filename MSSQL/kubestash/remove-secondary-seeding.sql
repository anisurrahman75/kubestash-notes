...
-- -- Step 4: Delete the database from the secondary replica
-- -- (This should be run on the secondary replica)
-- USE master;
-- DROP DATABASE [YourDatabaseName];
-- GO

-- -- Step 5: Resume data movement (if needed, on the primary replica)
